...
# make AMI_ID=ami-02f4ac1ec3a0ea661 ami-ec2-copy
# on Sun Sep 19 22:44:37 UTC 2021.
AMI_ID="ami-02f4ac1ec3a0ea661"
AMI_NAME="ordinary-experts-patterns-wordpress-1.2.0-3-g4642a29-20210919-1029"
generated_ami_ids = {
    "ap-northeast-1": "ami-0036bd69cdd8717c7",
    "ap-northeast-2": "ami-00d6b628ff5a636af",
    "ap-south-1": "ami-0ce824fa7291fdb40",
    "ap-southeast-1": "ami-0c223c99872731c9a",
    "ap-southeast-2": "ami-00db4dc42563bbebc",
    "ca-central-1": "ami-0ef1fd3a4a220f3c3",
    "eu-central-1": "ami-0f279e3e4c25867f7",
    "eu-north-1": "ami-00b5040bcb9a98e2f",
    "eu-west-1": "ami-006f82869ce4789c7",
    "eu-west-2": "ami-0ade0338559219868",
    "eu-west-3": "ami-0acdb25d77880d05a",
    "sa-east-1": "ami-001f9f467b7e7ed25",
    "us-east-1": "ami-02f4ac1ec3a0ea661",
    "us-east-2": "ami-0a1fa77331f204bf5",
    "us-west-1": "ami-09c669086d304080a",
    "us-west-2": "ami-04bff366060aecf1b",
    "us-east-1": "ami-02f4ac1ec3a0ea661"
}
...
class WordPressStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        db_backup_retention_period_param = core.CfnParameter(
            ...
            min_value=0,
            max_value=35,
            description="Optional: retention in days of RDS snapshots",
            type="Number"
        )
        ...
        db_cluster = aws_rds.CfnDBCluster(
            self,
            "DbCluster",
            backup_retention_period=core.Token.as_number(db_backup_retention_period_param.value),
