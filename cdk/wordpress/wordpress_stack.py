...
# make ami-ec2-build
AMI_ID="ami-075c11bdb1ae48d53"
AMI_NAME="ordinary-experts-patterns-wordpress-2.0.0-13-gb5cbcbd-20250218-1127"
generated_ami_ids = {
    ...
    "us-east-1": "ami-075c11bdb1ae48d53"
}
...
class WordPressStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        self.enable_sftp_param = CfnParameter(
            ...
            default="true",
            description="Required: Enable SFTP support."
        )
        self.sftp_ingress_cidr_param = CfnParameter(
            self,
            "SftpIngressCidr",
            allowed_pattern=r"^((\d{1,3})\.){3}\d{1,3}/\d{1,2}$",
            description="Required (if Enable SFTP is true): VPC IPv4 CIDR block to restrict access to inbound SFTP connections. Set to '0.0.0.0/0' to allow all access, or set to 'X.X.X.X/32' to restrict to one IP (replace Xs with your IP), or set to another CIDR range."
        )
